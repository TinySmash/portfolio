...
export default function About() {
  ...
  return (
    <div className='w-full h-screen absolute p-6 overflow-hidden'>
      ...
      <button className='CTC absolute w-auto bg-sky-500 p-2 rounded-full text-slate-200 font-bold text-2xl bottom-10 right-12 md:bottom-10 md:right-20 lg:text-3xl' onClick={() => {navigate("/")}}>Go back home</button>
